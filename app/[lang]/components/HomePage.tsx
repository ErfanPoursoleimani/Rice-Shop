...
const products = [
  {id: 3,
   href: '/products',
   img: <Image className="rounded-[4px] absolute w-70 h-95 z-1" src={type3} width={1000} alt="product"></Image>,
   label: "برنج کشت دوم",
  ...
  {id: 1,
   href: '/products',
   img: <Image className="rounded-[4px] absolute w-70 h-95 z-1" src={type1} width={1000} alt="product"></Image>,
   label: "برنج طارم فجر",
  ...
  {id: 2,
   href: '/products',
   img: <Image className="rounded-[4px] absolute w-70 h-95 z-1" src={type2} width={1000} alt="product"></Image>,
  ...
  return (
    <>
      <div className="text-end">
        <div className="relative min-h-[calc(100vh-130px)] bg-[url(@/public/rice-spoons.jpg)] bg-cover">
          <div className="absolute top-0 h-full w-full bg-[var(--light-foreground)]"></div>
          <div className="p-10 absolute top-[20%] md:right-[5%]">
        ...
        <div id="products" className="flex items-center justify-center min-h-130 bg-[var(--background)]">
