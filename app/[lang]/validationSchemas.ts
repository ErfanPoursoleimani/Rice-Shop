...
export const productSchema = z.object({
    ...
    price: z.number().min(1, 'مبلغ نمیتواند خالی باشد'),
    quantity: z.number().min(1, 'تعداد نمیتواند خالی باشد')
})

export const userSchema = z.object({
    phoneNumber: z.number().min(11, 'شماره تلفن باید متشکل از 11 عدد باشد').max(11, 'شماره تلفن باید متشکل از 11 عدد باشد')
